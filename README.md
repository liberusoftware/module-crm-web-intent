...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-web-intent?sort=semver)](https://github.com/liberusoftware/module-crm-web-intent/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-web-intent/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-web-intent/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-web-intent
```
...
<a href="https://github.com/liberusoftware/module-crm-web-intent/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-web-intent" alt="Contributors to liberusoftware/module-crm-web-intent">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-web-intent/graphs/contributors).
